...
class HotDrinkMachine {
  ...
  public HotDrinkMachine() throws Exception {
    ...
    for (AvailableDrink drink : AvailableDrink.values()) {
      ...
      Class<?> factory = Class.forName("com.pisoms.factories." + factoryName + "Factory");
    ...
    Set<Class<? extends IHotDrinkFactory>> types = new Reflections("com.pisoms.factories") // ""
        .getSubTypesOf(IHotDrinkFactory.class);
    for (Class<? extends IHotDrinkFactory> type : types) {
      namedFactories
          .add(new Pair<>(type.getSimpleName().replace("Factory", ""), type.getDeclaredConstructor().newInstance()));
    }
  }
